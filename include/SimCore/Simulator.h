...
public:
   ...
   */
  void beforeNewRun(
      std::shared_ptr<framework::AbstractRunHeader> header) final override;
   ...
   */
  void onNewRun(std::shared_ptr<const framework::AbstractRunHeader> header)
      final override;
...
private:
  ...
  /// PersistencyManager
  std::unique_ptr<simcore::persist::PersistencyManager> persistencyManager_;
